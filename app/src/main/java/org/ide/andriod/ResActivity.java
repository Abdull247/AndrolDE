...
public class ResActivity extends AppCompatActivity {
	...
	private String drawable_single_path = "";
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		listview1.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> _param1, View _param2, int _param3, long _param4) {
				final int _position = _param3;
				MaterialAlertDialogBuilder d = new MaterialAlertDialogBuilder(ResActivity.this);
		...
		imageview1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (folder.equals(getIntent().getStringExtra("spath").concat("/app/src/main/res"))) {
					finish();
				} else {
	...
	private void initializeLogic() {
		folder = getIntent().getStringExtra("spath").concat("/app/src/main/res");
		drawable_single_path = folder.concat("/drawable");
	...
	public void _menu1(final View _v) {
		try {
			...
			android.widget.PopupMenu popupMenu = new android.widget.PopupMenu(ResActivity.this, _v);
			
			// Manually add menu items using explicit structural integer constants
			popupMenu.getMenu().add(android.view.Menu.NONE, 1, android.view.Menu.NONE, "image Manager");
			popupMenu.getMenu().add(android.view.Menu.NONE, 2, android.view.Menu.NONE, "icons Library");
			popupMenu.getMenu().add(android.view.Menu.NONE, 3, android.view.Menu.NONE, "Collections");
			...
			popupMenu.setOnMenuItemClickListener(new android.widget.PopupMenu.OnMenuItemClickListener() {
				...
				public boolean onMenuItemClick(android.view.MenuItem item) {
					...
					if (id == 1) {
						i.setClass(ResActivity.this, ImageManagerActivity.class);
						i.putExtra("drawable_path", drawable_single_path);
						startActivity(i);
						return true;
					} 
					else if (id == 2) {
						i.setClass(ResActivity.this, JavActivity.class);
						i.putExtra("spath", getIntent().getStringExtra("path"));
						startActivity(i);
						return true;
					} 
					else if (id == 3) {
						i.setClass(ResActivity.this, LibActivity.class);
						i.putExtra("spath", getIntent().getStringExtra("path"));
						startActivity(i);
						return true;
					}
